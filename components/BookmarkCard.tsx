...
import { ExternalLink, Trash2, Globe, Edit2, Copy, Check, Share2 } from 'lucide-react';
...
const BookmarkCard: React.FC<BookmarkCardProps> = ({ bookmark, onDelete, onEdit }) => {
  ...
  const handleVisit = (e: React.MouseEvent) => {
    e.preventDefault();
    e.stopPropagation();
    // Open in a new tab/window, which typically forces the default browser in a PWA context
